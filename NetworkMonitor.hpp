...
public:
    ...
    // معیار چهارم: پهنای‌باند واقعی مشاهده‌شده (بُعد "Limited" از DDIL)
    void update_throughput(float throughput_kbps);
...
private:
    ...
    std::atomic<float> last_observed_throughput_{0.0f};
